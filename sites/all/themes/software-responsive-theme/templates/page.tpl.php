...
<?php
 /**
  * Use slideshow region for hero banners
  */
?>
<?php if ($node->type == "solution_landing" || $node->type == "solution_category"): ?>
  <div class="banner" style="background:url(/sites/all/files/public/<?php print $node->field_banner_image['und'][0]['filename'] ?>) no-repeat center; background-size: cover;">
  <?php if ($title): ?>
    <div class="page-title banner-title"><?php print $node->field_banner_title['und'][0]['value']; ?></div>
    <div class="banner-body"><?php print $node->field_banner_caption['und'][0]['value']; ?></div>
  <?php endif; ?>
  </div>
<?php endif; ?>
  ...
  <div id="container">
    <div class="container-wrap">
      <div class="content-sidebar-wrap">
	    ...
	    <?php if ($node->type !== "solution_landing"): ?>
